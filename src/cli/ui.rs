//! UI Module - Beautiful terminal UI matching original AgentRust
//!
//! This module provides styled output, colors, animations, and formatting
//! to match the aesthetic of the original TypeScript AgentRust CLI.
...
/// Print the AgentRust welcome banner
