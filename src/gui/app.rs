...
impl eframe::App for AgentRustApp {
...
pub fn run_gui() -> eframe::Result {
    ...
    eframe::run_native(
        "AgentRust",
        options,
        Box::new(|cc| Ok(Box::new(AgentRustApp::new(cc)))),
    )
}
