...
//! - claudeCodeGuideAgent: AgentRust guidance
...
impl std::fmt::Display for AgentType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            AgentType::AgentRustGuide => write!(f, "agentrust-guide"),
...
impl AgentsService {
    ...
    fn load_builtin_agents() -> HashMap<AgentType, AgentDefinition> {
        ...
        agents.insert(
            AgentType::AgentRustGuide,
            AgentDefinition {
                agent_type: AgentType::AgentRustGuide,
                name: "AgentRust Guide".to_string(),
                description: "Guides users through AgentRust features and best practices".to_string(),
                when_to_use: "When you need help understanding AgentRust features, commands, or workflows".to_string(),
                tools: vec!["file_read".to_string(), "search".to_string()],
                model: "sonnet".to_string(),
                system_prompt: r#"You are a AgentRust Guide agent. Your role is to help users understand and effectively use AgentRust.

Key responsibilities:
1. Explain AgentRust features and capabilities
