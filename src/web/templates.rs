...
<head>
    ...
    <title>AgentRust Plugin Marketplace</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <header>
            <h1>🔌 AgentRust Plugin Marketplace</h1>
            <p class="subtitle">Discover and install plugins to extend AgentRust's capabilities</p>
        ...
        <footer>
            <p>AgentRust Plugin Marketplace v{}</p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Plugin Details - AgentRust Marketplace</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Search Plugins - AgentRust Marketplace</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
