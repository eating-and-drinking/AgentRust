...
fn get_sample_plugins() -> Vec<Plugin> {
    vec![
        Plugin {
            ...
            author: "AgentRust Team".to_string(),
            author_url: Some("https://github.com/agentrust".to_string()),
            repository_url: Some("https://github.com/agentrust/file-system-plugin".to_string()),
            documentation_url: Some("https://docs.agentrust.dev/plugins/file-system".to_string()),
            icon_url: None,
        ...
        Plugin {
            ...
            author: "AgentRust Team".to_string(),
            author_url: Some("https://github.com/agentrust".to_string()),
            repository_url: Some("https://github.com/agentrust/git-plugin".to_string()),
            documentation_url: Some("https://docs.agentrust.dev/plugins/git".to_string()),
            icon_url: None,
        ...
        Plugin {
            ...
            description: "Send notifications and interact with Slack from AgentRust".to_string(),
